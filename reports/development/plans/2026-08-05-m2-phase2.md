...
These come from `AGENTS.md`, `standards.md`, `tech-stack.md`, and the approved spec (`reports/development/specs/2026-08-05-m2-phase2-design.md`) — every task below implicitly includes them:
