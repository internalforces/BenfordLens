...
3. Require standard CI, release metadata, and both native package jobs to pass; inspect retained
   ...
   exact inventory.
4. Merge the reviewed PR; then enable the selected-Action allowlist and full-SHA enforcement.
5. Import and verify the `main` and release-tag rulesets when GitHub Free public rulesets become
   available.
