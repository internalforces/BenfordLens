...
|----|-------------|----------|--------|
| ISS-006 | Repository visibility prevented unauthenticated source and package access | 2026-08-11 | After explicit TASK-044 approval, changed the repository to public and anonymously verified the source, pages, v1.0.1 Release, all six assets, and all three package checksums |
| TD-011 | Public-only GitHub scanning and reporting controls could not be proven while the repository was private | 2026-08-11 | Enabled secret scanning, push protection, and private vulnerability reporting; re-read repository protections; and passed the first public CodeQL analysis in run `31451987591` |
